...
#
#RUN unzip /wp-content/plugins/static-pro.zip -d /wp-content/plugins/ && \
#    rm /wp-content/plugins/static-pro.zip
#
...
ENV WORDPRESS_DB_HOST "example.internal."#ENV WORDPRESS_DB_USER "user"
ENV WORDPRESS_DB_PASSWORD "password"
ENV WORDPRESS_DB_NAME "my-database"
